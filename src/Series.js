...
class Series extends Component {
  constructor(props) {
    ...
    this.state = { isLoading: false, series: [] }
  ...
  loadData(){
    ...
    api.loadSeries(this.props.match.params.genre).then((res) => this.setState({ isLoading: false, series: res.data }))
  }
          ...
          <div className="caption">
            ...
            <div className="row">
              <div className="col-xs-12 col-md-6">
                ...
                <p className="lead">{statues[series.status]}</p>
              </div>
              <div className="col-xs-12 col-md-6">
                <Link className="btn btn-success" to={`/series-edit/${series.id}`}>Editar</Link><br/>
    ...
    return (
      <section id="intro" className="intro-section">
        ...
        <div id="series" className="row list-group">
          ...
          {!this.state.isLoading && this.state.series.length === 0 && <div className='alert alert-info'>Nenhuma série deste gênero cadastrada</div>}
